...
- 🎯 Actualmente sigo fortaleciendo mi lógica de programación y buenas prácticas.
...
|------|-------------|---------|
| ⚙️ **Backend** | Lógica de negocio, estructura de servidor y desarrollo de APIs con Python y Django. | Principal |
| 🗄️ **Análisis de Software y Bases de Datos** | Modelado de datos, normalización y consultas eficientes en MySQL. | Alto |
| 🎨 **Frontend** | Creación de interfaces funcionales con HTML, CSS y JavaScript básico. | Base |
...
<div align="center">
  <em>“El software es una combinación de lógica, creatividad y disciplina. Escribe código que te haga sentir orgulloso.”</em>
  <br />
  <sub>Hecho con ganas y dedicación por Eddier Antonio Paz Pardo</sub>
</div>
